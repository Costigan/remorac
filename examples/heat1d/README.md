...
RemoraC implementation of the one-dimensional heat conduction model
for the lunar regolith described in Hayne et al. (2017, *JGR Planets*
**122**, 2371–2400) and https://github.com/phayne/heat1d . Push as
much numerical work as possible into Remora (CPU-compiled); Python
